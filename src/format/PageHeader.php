...
class PageHeader
{
    ...
    static public $_TSPEC = array(
        ...
        5 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\DataPageHeader',
        ),
        6 => array(
            'var' => 'index_page_header',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\IndexPageHeader',
        ),
        7 => array(
            'var' => 'dictionary_page_header',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\DictionaryPageHeader',
        ),
        8 => array(
            'var' => 'data_page_header_v2',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\DataPageHeaderV2',
        ),
    );
    ...
    public $crc = null;
    /**
     * @var \hongkai\parquet\format\DataPageHeader
     */
    public $data_page_header = null;
    /**
     * @var \hongkai\parquet\format\IndexPageHeader
     */
    public $index_page_header = null;
    /**
     * @var \hongkai\parquet\format\DictionaryPageHeader
     */
    public $dictionary_page_header = null;
    /**
     * @var \hongkai\parquet\format\DataPageHeaderV2
     */
            ...
            switch ($fid) {
                ...
                case 5:
                    if ($ftype == TType::STRUCT) {
                        $this->data_page_header = new \hongkai\parquet\format\DataPageHeader();
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->index_page_header = new \hongkai\parquet\format\IndexPageHeader();
                ...
                case 7:
                    if ($ftype == TType::STRUCT) {
                        $this->dictionary_page_header = new \hongkai\parquet\format\DictionaryPageHeader();
                ...
                case 8:
                    if ($ftype == TType::STRUCT) {
                        $this->data_page_header_v2 = new \hongkai\parquet\format\DataPageHeaderV2();
