...
class EncryptionAlgorithm
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\AesGcmV1',
        ),
        2 => array(
            'var' => 'AES_GCM_CTR_V1',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\AesGcmCtrV1',
        ),
    );

    /**
     * @var \hongkai\parquet\format\AesGcmV1
     */
    public $AES_GCM_V1 = null;
    /**
     * @var \hongkai\parquet\format\AesGcmCtrV1
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->AES_GCM_V1 = new \hongkai\parquet\format\AesGcmV1();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->AES_GCM_CTR_V1 = new \hongkai\parquet\format\AesGcmCtrV1();
