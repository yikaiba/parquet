...
class FileMetaData
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkai\parquet\format\SchemaElement',
                ),
        ),
        3 => array(
            'var' => 'num_rows',
        ...
        4 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkai\parquet\format\RowGroup',
                ),
        ),
        5 => array(
        ...
        7 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkai\parquet\format\ColumnOrder',
                ),
        ),
        8 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\EncryptionAlgorithm',
        ),
        9 => array(
     ...
     * 
     * @var \hongkai\parquet\format\SchemaElement[]
     */
    public $schema = null;
    /**
     ...
     * 
     * @var \hongkai\parquet\format\RowGroup[]
     */
     ...
     * 
     * @var \hongkai\parquet\format\ColumnOrder[]
     */
     ...
     * 
     * @var \hongkai\parquet\format\EncryptionAlgorithm
     */
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i88 = 0; $_i88 < $_size84; ++$_i88) {
                            $elem89 = null;
                            $elem89 = new \hongkai\parquet\format\SchemaElement();
                ...
                case 4:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i94 = 0; $_i94 < $_size90; ++$_i94) {
                            $elem95 = null;
                            $elem95 = new \hongkai\parquet\format\RowGroup();
                ...
                case 5:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i100 = 0; $_i100 < $_size96; ++$_i100) {
                            $elem101 = null;
                            $elem101 = new \hongkai\parquet\format\KeyValue();
                ...
                case 7:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i106 = 0; $_i106 < $_size102; ++$_i106) {
                            $elem107 = null;
                            $elem107 = new \hongkai\parquet\format\ColumnOrder();
                ...
                case 8:
                    if ($ftype == TType::STRUCT) {
                        $this->encryption_algorithm = new \hongkai\parquet\format\EncryptionAlgorithm();
