...
class TimeUnit
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\MilliSeconds',
        ),
        2 => array(
            'var' => 'MICROS',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\MicroSeconds',
        ),
        3 => array(
            'var' => 'NANOS',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\NanoSeconds',
        ),
    );

    /**
     * @var \hongkai\parquet\format\MilliSeconds
     */
    public $MILLIS = null;
    /**
     * @var \hongkai\parquet\format\MicroSeconds
     */
    public $MICROS = null;
    /**
     * @var \hongkai\parquet\format\NanoSeconds
     */
    public $NANOS = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->MILLIS = new \hongkai\parquet\format\MilliSeconds();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->MICROS = new \hongkai\parquet\format\MicroSeconds();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->NANOS = new \hongkai\parquet\format\NanoSeconds();
