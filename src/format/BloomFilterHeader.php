...
class BloomFilterHeader
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\BloomFilterAlgorithm',
        ),
        3 => array(
            'var' => 'hash',
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\BloomFilterHash',
        ),
        4 => array(
            'var' => 'compression',
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\BloomFilterCompression',
        ),
    );
     ...
     * 
     * @var \hongkai\parquet\format\BloomFilterAlgorithm
     */
    public $algorithm = null;
    /**
     * The hash function used for Bloom filter. *
     * 
     * @var \hongkai\parquet\format\BloomFilterHash
     */
    public $hash = null;
    /**
     * The compression used in the Bloom filter *
     * 
     * @var \hongkai\parquet\format\BloomFilterCompression
     */
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->algorithm = new \hongkai\parquet\format\BloomFilterAlgorithm();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->hash = new \hongkai\parquet\format\BloomFilterHash();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->compression = new \hongkai\parquet\format\BloomFilterCompression();
