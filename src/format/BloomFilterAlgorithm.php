...
class BloomFilterAlgorithm
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\SplitBlockAlgorithm',
        ),
    );
     ...
     * 
     * @var \hongkai\parquet\format\SplitBlockAlgorithm
     */
    public $BLOCK = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->BLOCK = new \hongkai\parquet\format\SplitBlockAlgorithm();
