...
class ColumnChunk
{
    ...
    static public $_TSPEC = array(
        ...
        3 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\ColumnMetaData',
        ),
        4 => array(
        ...
        8 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\ColumnCryptoMetaData',
        ),
        9 => array(
     ...
     * 
     * 
     * @var \hongkai\parquet\format\ColumnMetaData
     */
     ...
     * 
     * @var \hongkai\parquet\format\ColumnCryptoMetaData
     */
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->meta_data = new \hongkai\parquet\format\ColumnMetaData();
                ...
                case 8:
                    if ($ftype == TType::STRUCT) {
                        $this->crypto_metadata = new \hongkai\parquet\format\ColumnCryptoMetaData();
