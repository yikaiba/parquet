...
class ColumnCryptoMetaData
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\EncryptionWithFooterKey',
        ),
        2 => array(
            'var' => 'ENCRYPTION_WITH_COLUMN_KEY',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkai\parquet\format\EncryptionWithColumnKey',
        ),
    );

    /**
     * @var \hongkai\parquet\format\EncryptionWithFooterKey
     */
    public $ENCRYPTION_WITH_FOOTER_KEY = null;
    /**
     * @var \hongkai\parquet\format\EncryptionWithColumnKey
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->ENCRYPTION_WITH_FOOTER_KEY = new \hongkai\parquet\format\EncryptionWithFooterKey();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->ENCRYPTION_WITH_COLUMN_KEY = new \hongkai\parquet\format\EncryptionWithColumnKey();
